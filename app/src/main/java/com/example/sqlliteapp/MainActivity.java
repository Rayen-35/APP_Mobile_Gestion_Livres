    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_navig:
                ...
                if (item.getTitle().equals("navigateur")){
            ...
            case R.id.menu_help:
                ...
                info.setMessage("Project  BY Gragba Rayen Chtourou Oumaima and Mathlouthi Rayen  TO encourage students to  Read books  \n thank you Mrs Faten for this opportunity")
